...
CREATE TABLE `main_slider` (
  ...
  CONSTRAINT `main_slider_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `filer_file` (`id`) ON DELETE CASCADE
...
INSERT INTO `main_slider` VALUES (5,'space1',19,0),(6,'картиночка 2',20,0),(7,'картиночка 3',21,0),(8,'Картиночка 4',22,0),(9,'Картиночка 5',23,0);
